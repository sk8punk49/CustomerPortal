...
function LandingPage() {
  ...
  const tradeshowEventDetails = {
    ...
    startTime: "April 4 12:00PM (PT)",
    endTime: "April 5 10:00PM (PT)",
    location: "Pacific National Exhibition",
  };

  const tradeshowOnlineDetails = {
    title: "32th Annual Lordco Tradeshow",
      ...
      >
        <motion.div variants={item} className="flex w-full mb-12  lg:mr-12">
          <Paper className="w-full rounded-20 shadow">
              ...
              <Table>
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>{tradeshowEventDetails.startTime}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Ends:</TableCell>
                    <TableCell>{tradeshowEventDetails.endTime}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Location:</TableCell>
                    <TableCell>{tradeshowEventDetails.location}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </CardContent>
            ...
            <CardContent>
              <Typography variant="h5">Online Ordering</Typography>
              <Table>
                <TableBody>
                  <TableRow>
                    <TableCell colSpan={2}>
                      <Typography color="textSecondary" className="font-medium">
                        {tradeshowOnlineDetails.title}
                      </Typography>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Starts:</TableCell>
                    <TableCell>{tradeshowOnlineDetails.startTime}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>Ends:</TableCell>
                    <TableCell>{tradeshowOnlineDetails.endTime}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </CardContent>
        ...
        <motion.div variants={item} className="lg:flex sm:flex-col">
          <Paper className="w-full rounded-20 shadow">
            <CardContent>
              ...
              <div className="flex">
                <img
                  className="w-48 mr-12 hidden md:flex"
                  src="/assets/images/clip-art/ts_icon_1.png"
                />
                <span className="mt-4">
          ...
          <Paper className="w-full rounded-20 shadow mt-16">
            <CardContent>
              ...
              <div className="flex">
                <img
                  className="w-48 mr-12 hidden md:flex"
                  src="/assets/images/clip-art/ts_icon_2.png"
                />
                <span className="mt-4">
                  Learn about new products, direct from the manufacturers, from
                  April 4-5.
                </span>
              </div>
              <Button
            ...
            <CardContent>
              ...
              <div className="flex">
                <img
                  ...
                  className="w-48 mr-12 hidden md:flex"
                  src="/assets/images/clip-art/ts_icon_3.png"
                />
                <span className="mt-4">
                  Take advantage of Red Sheet Specials, the best prices on our
                  most popular items.
                </span>
              </div>
              <Button
