...
function ViewCart(props) {
  ...
  function invoiceGrandTotal() {
    ...
    cartItems.items.map((row) => (invoiceTotal += row.extended));
        ...
        >
          ...
          >
            <div className="p-24 print:p-0">
              ...
              <div
                className="mt-40 print:mt-0 h-400 overflow-auto"
                  ...
                  <TableBody>
                    {cartItems.items.map((row, id) => (
                      <TableRow key={row.detailId}>
                        ...
                        <TableCell align="right">${row.extended}</TableCell>
                        <TableCell align="right">
                          <Icon
                            onClick={() => removeTradeshowItem(id)}
